...
var renderHeader = function renderHeader(breadcrumb, _ref2) {
  var backIcon = _ref2.backIcon,
      onBack = _ref2.onBack;

  // by design,Bread crumbs and back icon can only have one
  if (backIcon && onBack) {
    if (breadcrumb && breadcrumb.routes) {
      (0, _warning["default"])(false, 'page-header', 'breadcrumbs and back icon can only have one');
    }
...
var PageHeader = function PageHeader(props) {
  return React.createElement(_configProvider.ConfigConsumer, null, function (_ref3) {
    ...
    var breadcrumbDom = renderHeader(breadcrumb, props);
