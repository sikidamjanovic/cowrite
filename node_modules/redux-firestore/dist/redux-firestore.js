...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n\nvar _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };\n\nexports.requestingReducer = requestingReducer;\nexports.requestedReducer = requestedReducer;\nexports.timestampsReducer = timestampsReducer;\n\nvar _constants = __webpack_require__(/*! ../constants */ \"./src/constants.js\");\n\nvar _reducers = __webpack_require__(/*! ../utils/reducers */ \"./src/utils/reducers.js\");\n\nvar _query = __webpack_require__(/*! ../utils/query */ \"./src/utils/query.js\");\n\nfunction _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }\n\nvar SET_LISTENER = _constants.actionTypes.SET_LISTENER,\n    LISTENER_ERROR = _constants.actionTypes.LISTENER_ERROR,\n    LISTENER_RESPONSE = _constants.actionTypes.LISTENER_RESPONSE;\nfunction requestingReducer() {\n  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};\n  var _ref = arguments[1];\n  var type = _ref.type,\n      meta = _ref.meta;\n\n  switch (type) {\n    case SET_LISTENER:\n      return _extends({}, state, _defineProperty({}, (0, _reducers.getSlashStrPath)((0, _query.getQueryName)(meta)), true));\n    case LISTENER_ERROR:\n    case LISTENER_RESPONSE:\n      return _extends({}, state, _defineProperty({}, (0, _reducers.getSlashStrPath)((0, _query.getQueryName)(meta)), false));\n    default:\n      return state;\n  }\n}\n\nfunction requestedReducer() {\n  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};\n  var _ref2 = arguments[1];\n  var type = _ref2.type,\n      meta = _ref2.meta;\n\n  switch (type) {\n    case SET_LISTENER:\n      return _extends({}, state, _defineProperty({}, (0, _query.getQueryName)(meta), false));\n    case LISTENER_ERROR:\n    case LISTENER_RESPONSE:\n      return _extends({}, state, _defineProperty({}, (0, _query.getQueryName)(meta), true));\n    default:\n      return state;\n  }\n}\n\nfunction timestampsReducer() {\n  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};\n  var _ref3 = arguments[1];\n  var type = _ref3.type,\n      meta = _ref3.meta;\n\n  switch (type) {\n    case SET_LISTENER:\n      return _extends({}, state, _defineProperty({}, (0, _query.getQueryName)(meta), Date.now()));\n    default:\n      return state;\n  }\n}\n\nexports.default = (0, _reducers.combineReducers)({\n  requesting: requestingReducer,\n  requested: requestedReducer,\n  timestamps: timestampsReducer\n});\n\n//# sourceURL=webpack://ReduxFirestore/./src/reducers/statusReducer.js?");
